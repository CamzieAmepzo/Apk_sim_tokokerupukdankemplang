        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Kelola Kategori / Edit Data</h4>
                            </div>
                ...
                <div class="pd-20 card-box mb-30">
                    <form action="{{ route('kategori_edit', $edit->id_kategori) }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="nama_kategori"
                                    value="{{ $edit->nama_kategori }}" placeholder="Input Kategori" required>
                            </div>
                        </div>
