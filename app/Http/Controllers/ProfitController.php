...
class PKLController extends Controller
{
    public function index()
    {
        ...
        $pilih_kategori = kategori::all();
        $pembayaran = Pembayaran::where('jenis_pembayaran', 'Uang Profit')->first();
        $barang = Uang_Profit::rightjoin('barang', '.id_barang', '=', 'barang.id_barang')->leftjoin('kategori', 'barang.id_kategori', '=', 'kategori.id_kategori')->leftjoin('jenisbarang', 'barang.id_jenisbarang', '=', 'jenisbarang.id_jenisbarang')
            ->select(
                'barang.barang',
                'kategori.id_kategori',
                'jenisbarang.nama_jenisbarang',
                'uang_profit.status as status_uang',
                'uang_profit.id_uang_profit',
                'uang_profit.nominal',
                'barang.id_barang'
            )->get();
        return view('halaman_admin.uang_profit.index', compact('barang', 'pembayaran', 'kategori'));
    }
